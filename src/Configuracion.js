...
function Configuracion() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const response = await fetch('https://petcare-backend-193c8a8cd9bf.herokuapp.com/api/update-profile', {
                method: 'POST',
                headers: {
                ...
                <Container className='col-12'>
                    ...
                    <Row className='d-flex'>
                        <Col md={3} className='me-5 mb-3'>
                            <ClientCardProfile name={authData.name} file_path={`https://petcare-backend-193c8a8cd9bf.herokuapp.com/${authData.file_path}`} />
