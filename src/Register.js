...
function Register() {
    ...
    const axiosInstance = axios.create({
        baseURL: 'https://petcare-backend-193c8a8cd9bf.herokuapp.com/api',
        headers: {
    ...
    const csrfAxiosInstance = axios.create({
        baseURL: 'https://petcare-backend-193c8a8cd9bf.herokuapp.com',
        //withCredentials: true // Permite que Axios envíe cookies con las solicitudes
    });
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const response = await axiosInstance.post('https://petcare-backend-193c8a8cd9bf.herokuapp.com/api/register',form);
