...
function VerCliente() {
    ...
    useEffect(() => {
        const fetchClient = async () => {
            ...
            try {
                const response = await axios.get(`https://petcare-backend-193c8a8cd9bf.herokuapp.com/api/clients/${id}`, {
                    headers: {
            ...
            <Container className='col-12'>
                ...
                <Row className='d-flex'>
                    <Col md={3} className='me-5 mb-3'>
                        <ClientCardProfile name={client.name} file_path={`https://petcare-backend-193c8a8cd9bf.herokuapp.com/${client.file_path}`} />
                    </Col>
